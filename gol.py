...
''' Code to implement John Conway's Game of Life (Memory optimised)'''
...
Game of Life is a zero player cell game on an infinite grid 
A live cell lives in the next generation if the number of its live neighbour cells is either 2 or 3
A live cell dies in the next generation due to isolation if the number of live neighbours is less than 2
A live cell dies in the next generation due to overpopulation if the number of live neighbours is more than 3
A dead cell comes to life in the next generation if the number of live neighbours is 3, else it stays dead
